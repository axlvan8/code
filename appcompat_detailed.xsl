...
<xsl:stylesheet
 ...
 <UL>
 <xsl:for-each select="CompatReport/HardBlocks">
        <font size = "2" face="Segoe UI" color="black"><xsl:value-of select="Message0"/></font>
  </xsl:for-each>
  </UL>
  <UL><UL>
  <xsl:for-each select="CompatReport/HardBlocks/UnDrvNames/UnDrvName">

        <font size = "2" face="Segoe UI" color="black"><li><xsl:copy-of select="Name"/></li></font>
  </xsl:for-each>
  </UL></UL>
  <xsl:for-each select="CompatReport/HardBlocks/UnDrvNames">
      <UL><UL><a href="#{generate-id(.)}">
	<font size = "2" face="Segoe UI" color="blue"><xsl:value-of select="./Help"/></font>
         </a>
      </UL></UL>
  </xsl:for-each>
